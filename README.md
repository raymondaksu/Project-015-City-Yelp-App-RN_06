...
<div align="center">
  <h3><a id="user-content-----------project-source------" class="anchor" aria-hidden="true" href="#----------project-source------"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M7.775 3.275a.75.75 0 001.06 1.06l1.25-1.25a2 2 0 112.83 2.83l-2.5 2.5a2 2 0 01-2.83 0 .75.75 0 00-1.06 1.06 3.5 3.5 0 004.95 0l2.5-2.5a3.5 3.5 0 00-4.95-4.95l-1.25 1.25zm-4.69 9.64a2 2 0 010-2.83l2.5-2.5a2 2 0 012.83 0 .75.75 0 001.06-1.06 3.5 3.5 0 00-4.95 0l-2.5 2.5a3.5 3.5 0 004.95 4.95l1.25-1.25a.75.75 0 00-1.06-1.06l-1.25 1.25a2 2 0 01-2.83 0z"></path></svg></a>
    <a href="https://github.com/raymondaksu/Project-015-City-Yelp-App-RN_06/">
      Project Source
    </a>
  </h3>
</div>
...
<p><a target="_blank" rel="noopener noreferrer" href="https://github.com/raymondaksu/Project-015-City-Yelp-App-RN_06/blob/main/CityYelpApp_1.gif"><img src="https://github.com/raymondaksu/Project-015-City-Yelp-App-RN_06/blob/main/CityYelpApp_1.gif" height="500" style="max-width:100%;">  <img src="https://github.com/raymondaksu/Project-015-City-Yelp-App-RN_06/blob/main/CityYelpApp_2.gif" height="500" style="max-width:100%;"></a></p>
...
<li>User can scroll down and up to see a list of cities and search a city in search bar. Source is pulled API from 'https://opentable.herokuapp.com/api/cities'</li>
<li>When the user tap on the any city, resaurant lists are displayed on the screen with limited details.</li>
<li>User can scroll down and up to see a list of restaurants which belongs to tapped city before. There is a search bar which allow us search a restaurant from the list. Source is pulled API from 'http://opentable.herokuapp.com/api/restaurants'</li>
<li>After tap on a restaurant object, the restaurant details are displayed on the screen.</li>
<li>When clicked on a 'button' of 'Go to Reservation'; redirected to the restaurant page. Shown a tabbar bottom of page which allow us roam in restaurants reservation page, go back, back to apps last page and back to home page.</li>
</ul>
